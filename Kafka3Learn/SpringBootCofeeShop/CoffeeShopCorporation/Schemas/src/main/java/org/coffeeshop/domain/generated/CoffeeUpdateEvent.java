...
public class CoffeeUpdateEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4451272505238689292L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CoffeeUpdateEvent\",\"namespace\":\"org.coffeeshop.domain.generated\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"status\",\"type\":{\"type\":\"enum\",\"name\":\"OrderStatus\",\"symbols\":[\"PROCESSING\",\"READY_FOR_PICK_UP\"],\"default\":\"PROCESSING\"},\"default\":\"PROCESSING\"}]}");
...
static {
  ...
  @Deprecated public org.coffeeshop.domain.generated.OrderStatus status;
   ...
   */
  public CoffeeUpdateEvent(java.util.UUID id, org.coffeeshop.domain.generated.OrderStatus status) {
    this.id = id;
    this.status = status;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: status = (org.coffeeshop.domain.generated.OrderStatus)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public org.coffeeshop.domain.generated.OrderStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(org.coffeeshop.domain.generated.OrderStatus value) {
    this.status = value;
  }
   ...
   */
  public static org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder newBuilder() {
    return new org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder();
  }
   ...
   * @return A new CoffeeUpdateEvent RecordBuilder
   */
  public static org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder newBuilder(org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder other) {
    if (other == null) {
      return new org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder();
    } else {
      return new org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder(other);
    }
  }
   ...
   * @return A new CoffeeUpdateEvent RecordBuilder
   */
  public static org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder newBuilder(org.coffeeshop.domain.generated.CoffeeUpdateEvent other) {
    if (other == null) {
      return new org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder();
    } else {
      return new org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CoffeeUpdateEvent>
    ...
    private org.coffeeshop.domain.generated.OrderStatus status;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.coffeeshop.domain.generated.CoffeeUpdateEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder setStatus(org.coffeeshop.domain.generated.OrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.CoffeeUpdateEvent.Builder clearStatus() {
      status = null;
    ...
    public CoffeeUpdateEvent build() {
      try {
        ...
        record.status = fieldSetFlags()[1] ? this.status : (org.coffeeshop.domain.generated.OrderStatus) defaultValue(fields()[1]);
        return record;
