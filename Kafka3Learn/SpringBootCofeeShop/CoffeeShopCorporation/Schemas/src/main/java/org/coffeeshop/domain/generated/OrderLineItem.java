...
public class OrderLineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2184727243488295376L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderLineItem\",\"namespace\":\"org.coffeeshop.domain.generated\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"size\",\"type\":{\"type\":\"enum\",\"name\":\"Size\",\"symbols\":[\"SMALL\",\"MEDIUM\",\"LARGE\"],\"default\":\"LARGE\"},\"default\":\"LARGE\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"cost\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":3,\"scale\":2}}]}");
...
static {
  ...
  @Deprecated public org.coffeeshop.domain.generated.Size size;
   ...
   */
  public OrderLineItem(java.lang.CharSequence name, org.coffeeshop.domain.generated.Size size, java.lang.Integer quantity, java.math.BigDecimal cost) {
    this.name = name;
    this.size = size;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: size = (org.coffeeshop.domain.generated.Size)value$; break;
   ...
   */
  public org.coffeeshop.domain.generated.Size getSize() {
    return size;
  }
   ...
   * @param value the value to set.
   */
  public void setSize(org.coffeeshop.domain.generated.Size value) {
    this.size = value;
  }
   ...
   */
  public static org.coffeeshop.domain.generated.OrderLineItem.Builder newBuilder() {
    return new org.coffeeshop.domain.generated.OrderLineItem.Builder();
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static org.coffeeshop.domain.generated.OrderLineItem.Builder newBuilder(org.coffeeshop.domain.generated.OrderLineItem.Builder other) {
    if (other == null) {
      return new org.coffeeshop.domain.generated.OrderLineItem.Builder();
    } else {
      return new org.coffeeshop.domain.generated.OrderLineItem.Builder(other);
    }
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static org.coffeeshop.domain.generated.OrderLineItem.Builder newBuilder(org.coffeeshop.domain.generated.OrderLineItem other) {
    if (other == null) {
      return new org.coffeeshop.domain.generated.OrderLineItem.Builder();
    } else {
      return new org.coffeeshop.domain.generated.OrderLineItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderLineItem>
    ...
    private org.coffeeshop.domain.generated.Size size;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.coffeeshop.domain.generated.OrderLineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.coffeeshop.domain.generated.OrderLineItem other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.OrderLineItem.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.OrderLineItem.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.OrderLineItem.Builder setSize(org.coffeeshop.domain.generated.Size value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.OrderLineItem.Builder clearSize() {
      size = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.OrderLineItem.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.OrderLineItem.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.OrderLineItem.Builder setCost(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.OrderLineItem.Builder clearCost() {
      cost = null;
    ...
    public OrderLineItem build() {
      try {
        ...
        record.size = fieldSetFlags()[1] ? this.size : (org.coffeeshop.domain.generated.Size) defaultValue(fields()[1]);
