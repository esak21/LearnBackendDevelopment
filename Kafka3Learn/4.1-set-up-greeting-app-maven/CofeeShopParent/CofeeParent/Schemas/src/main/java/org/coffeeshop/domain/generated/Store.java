...
public class Store extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2853742314730498464L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Store\",\"namespace\":\"org.coffeeshop.domain.generated\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"address\",\"type\":{\"type\":\"record\",\"name\":\"Address\",\"fields\":[{\"name\":\"addressLine1\",\"type\":\"string\"},{\"name\":\"city\",\"type\":\"string\"},{\"name\":\"state_province\",\"type\":\"string\"},{\"name\":\"country\",\"type\":\"string\"},{\"name\":\"zip\",\"type\":\"string\"}]}}]}");
  ...
  @Deprecated public org.coffeeshop.domain.generated.Address address;
   ...
   */
  public Store(java.lang.Integer id, org.coffeeshop.domain.generated.Address address) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: address = (org.coffeeshop.domain.generated.Address)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public org.coffeeshop.domain.generated.Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(org.coffeeshop.domain.generated.Address value) {
    this.address = value;
  }
   ...
   */
  public static org.coffeeshop.domain.generated.Store.Builder newBuilder() {
    return new org.coffeeshop.domain.generated.Store.Builder();
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static org.coffeeshop.domain.generated.Store.Builder newBuilder(org.coffeeshop.domain.generated.Store.Builder other) {
    if (other == null) {
      return new org.coffeeshop.domain.generated.Store.Builder();
    } else {
      return new org.coffeeshop.domain.generated.Store.Builder(other);
    }
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static org.coffeeshop.domain.generated.Store.Builder newBuilder(org.coffeeshop.domain.generated.Store other) {
    if (other == null) {
      return new org.coffeeshop.domain.generated.Store.Builder();
    } else {
      return new org.coffeeshop.domain.generated.Store.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Store>
    ...
    private int id;
    private org.coffeeshop.domain.generated.Address address;
    private org.coffeeshop.domain.generated.Address.Builder addressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.coffeeshop.domain.generated.Store.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = org.coffeeshop.domain.generated.Address.newBuilder(other.getAddressBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.coffeeshop.domain.generated.Store other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.Store.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.Store.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.Store.Builder setAddress(org.coffeeshop.domain.generated.Address value) {
     ...
     * @return This builder.
     */
    public org.coffeeshop.domain.generated.Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(org.coffeeshop.domain.generated.Address.newBuilder(address));
        } else {
          setAddressBuilder(org.coffeeshop.domain.generated.Address.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public org.coffeeshop.domain.generated.Store.Builder setAddressBuilder(org.coffeeshop.domain.generated.Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public org.coffeeshop.domain.generated.Store.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    public Store build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[1] ? this.address : (org.coffeeshop.domain.generated.Address) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.address == null) {
        this.address = new org.coffeeshop.domain.generated.Address();
      }
