 ...
 */
package com.learnavro.cogesak.avroschemas;
...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8473537601740080515L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"com.learnavro.cogesak.avroschemas\",\"fields\":[{\"name\":\"greeting\",\"type\":\"string\"}]}");
   ...
   */
  public Greeting(java.lang.CharSequence greeting) {
   ...
   */
  public static com.learnavro.cogesak.avroschemas.Greeting.Builder newBuilder() {
    return new com.learnavro.cogesak.avroschemas.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static com.learnavro.cogesak.avroschemas.Greeting.Builder newBuilder(com.learnavro.cogesak.avroschemas.Greeting.Builder other) {
    if (other == null) {
      return new com.learnavro.cogesak.avroschemas.Greeting.Builder();
    } else {
      return new com.learnavro.cogesak.avroschemas.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static com.learnavro.cogesak.avroschemas.Greeting.Builder newBuilder(com.learnavro.cogesak.avroschemas.Greeting other) {
    if (other == null) {
      return new com.learnavro.cogesak.avroschemas.Greeting.Builder();
    } else {
      return new com.learnavro.cogesak.avroschemas.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.learnavro.cogesak.avroschemas.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.learnavro.cogesak.avroschemas.Greeting other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learnavro.cogesak.avroschemas.Greeting.Builder setGreeting(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learnavro.cogesak.avroschemas.Greeting.Builder clearGreeting() {
      greeting = null;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.greeting = in.readString(this.greeting instanceof Utf8 ? (Utf8)this.greeting : null);
