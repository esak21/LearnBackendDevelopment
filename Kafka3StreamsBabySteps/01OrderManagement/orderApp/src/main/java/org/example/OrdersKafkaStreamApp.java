...
import org.example.Topology.OrdersTopology;

import java.util.List;
import java.util.Properties;
import java.util.stream.Collectors;

import static org.example.Topology.OrdersTopology.*;
...
public class OrdersKafkaStreamApp {
    ...
    public static void main(String[] args) {
        ...
        config.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest"); // read only the new messages
        ...
        createTopics(config, List.of( ORDERS, GENERALORDERS, RESTORDERS, STORES));
